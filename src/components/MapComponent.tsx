...
const vibeColorsHex: Record<VibeType, string> = {
  ...
  // Canadian winter / climate types
  [VibeType.SnowAccumulation]: '#bfdbfe', // Light blue (snow)
  [VibeType.IcySidewalk]: '#93c5fd',      // Sky blue (ice)
  [VibeType.UnplowedRoad]: '#60a5fa',     // Blue (unplowed)
  [VibeType.Flooding]: '#1d4ed8',         // Dark blue (flooding)
};
